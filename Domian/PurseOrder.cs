...
namespace Domian
{
    public class PurseOrder
    {
        ...
        public ICollection<KemiaOrder>? kemiaOrders { get; set; }

        public Depend? Depend { get; set; }
        public PurseOrder(string? des, string? email, string? address, string? clientname, string? clientnumber, string? mname, string? car, string? carN, string? paymment, string? hekal, string? username,string? u ,string? p)
        {
            Description = des;
            Email = email;
            Address = address;
            ...
            userPhone = p;
            UserFName = u;
            kemiaOrders = new List<KemiaOrder>();
        }


        public PurseOrder() : this(null, null, null, null, null, null, null, null, null, null, null, null, null)
        {
