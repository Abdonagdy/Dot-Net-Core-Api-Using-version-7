    ...
    public class UserAccountRepository : IUserAccountRepository
    {
        ...
        public async Task<AuthModel> Registration(RegistrationModel registrationModel)
        {
            ...
            var autnModel = new AuthModel
            {
                ...
                UrlReferralCode = _user.UrlReferralCode!,
        ...
        public async Task<AuthModel> Login(LoginModel loginModel)
        {
            ...
            authModel.Lname = _user.Lname!;
            authModel.Fname = _user.Fname!;
            authModel.PhoneNumber = _user.PhoneNumber!;
            authModel.ExpiresOn = jwtSecurityToken.ValidTo;
            authModel.Token = new JwtSecurityTokenHandler().WriteToken(jwtSecurityToken);
            authModel.Roles = rollist.ToList();
            authModel.ReferralCode = _user.ReferralCode;
            authModel.UrlReferralCode = _user.UrlReferralCode;
            return authModel;
        }
        ...
        public async Task<AuthModel> GetCurrentUser(string email)
        {
            ...
            var autnModel = new AuthModel
            {
                ...
                UrlReferralCode = user.UrlReferralCode!,
                Token = new JwtSecurityTokenHandler().WriteToken(jwtSecurityToken)
