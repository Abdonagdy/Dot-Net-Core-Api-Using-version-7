...
namespace DBContext.Migrations
{
    ...
    [Migration("20240813105328_uu12356796")]
    partial class uu12356796
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domian.Depend", b =>
                {
                    b.HasOne("Domian.PurseOrder", "PurseOrder")
                        .WithOne("Depend")
                        .HasForeignKey("Domian.Depend", "PrId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Domian.DependHomolla", b =>
                {
                    b.HasOne("Domian.PurseOrderHomalla", "PurseOrder")
                        .WithOne("DependHomolla")
                        .HasForeignKey("Domian.DependHomolla", "PrId")
                        .OnDelete(DeleteBehavior.Cascade);
